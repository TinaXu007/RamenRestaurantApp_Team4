...
public class FragmentOffersBindingImpl extends FragmentOffersBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_view_offers, 1);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.offers == variableId) {
            setOffers((com.alpharamen.customer.viewmodel.OffersViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setOffers(@Nullable com.alpharamen.customer.viewmodel.OffersViewModel Offers) {
        this.mOffers = Offers;
    }
