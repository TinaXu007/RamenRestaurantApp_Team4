...
public final class SignupActivity_MembersInjector implements MembersInjector<SignupActivity> {
  ...
  public static MembersInjector<SignupActivity> create(
      Provider<ToastUtils> toastUtilsProvider,
      Provider<ViewModelProviderFactory> mViewModelFactoryProvider) {
    return new SignupActivity_MembersInjector(toastUtilsProvider, mViewModelFactoryProvider);
  }
  ...
  public static void injectMViewModelFactory(
      SignupActivity instance, ViewModelProviderFactory mViewModelFactory) {
