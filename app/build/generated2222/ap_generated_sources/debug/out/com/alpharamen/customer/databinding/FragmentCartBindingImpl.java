...
public class FragmentCartBindingImpl extends FragmentCartBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.lottie_animation_view, 2);
        sViewsWithIds.put(R.id.text_view_cart_heading, 3);
        sViewsWithIds.put(R.id.guideline_separator, 4);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.cart == variableId) {
            setCart((com.alpharamen.customer.viewmodel.CartViewModel) variable);
        }
        else if (BR.listener == variableId) {
            setListener((android.view.View.OnClickListener) variable);
        }
        else if (BR.empty == variableId) {
            setEmpty((java.lang.Integer) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCart(@Nullable com.alpharamen.customer.viewmodel.CartViewModel Cart) {
        this.mCart = Cart;
    }
    ...
    public void setEmpty(@Nullable java.lang.Integer Empty) {
        this.mEmpty = Empty;
    }
