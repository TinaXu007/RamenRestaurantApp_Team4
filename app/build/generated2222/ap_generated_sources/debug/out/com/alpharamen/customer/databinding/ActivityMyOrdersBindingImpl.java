...
public class ActivityMyOrdersBindingImpl extends ActivityMyOrdersBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_view_my_orders, 2);
        sViewsWithIds.put(R.id.recycler_view_orders, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        else if (BR.myorders == variableId) {
            setMyorders((com.alpharamen.customer.viewmodel.MyOrdersViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMyorders(@Nullable com.alpharamen.customer.viewmodel.MyOrdersViewModel Myorders) {
