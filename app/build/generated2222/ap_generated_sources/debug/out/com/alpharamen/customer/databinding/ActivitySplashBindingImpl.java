...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.splash == variableId) {
            setSplash((com.alpharamen.customer.viewmodel.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSplash(@Nullable com.alpharamen.customer.viewmodel.SplashViewModel Splash) {
        this.mSplash = Splash;
    }
