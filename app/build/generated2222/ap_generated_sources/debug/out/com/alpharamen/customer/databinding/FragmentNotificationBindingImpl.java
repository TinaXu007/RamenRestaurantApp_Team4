...
public class FragmentNotificationBindingImpl extends FragmentNotificationBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_view_notification_heading, 1);
        sViewsWithIds.put(R.id.recycler_view_notification_list, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.notify == variableId) {
            setNotify((com.alpharamen.customer.viewmodel.NotificationFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setNotify(@Nullable com.alpharamen.customer.viewmodel.NotificationFragmentViewModel Notify) {
        this.mNotify = Notify;
    }
