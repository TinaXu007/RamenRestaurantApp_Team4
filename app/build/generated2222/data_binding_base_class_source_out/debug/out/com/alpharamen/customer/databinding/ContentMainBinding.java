...
public abstract class ContentMainBinding extends ViewDataBinding {
  @NonNull
  public final RecyclerView recyclerViewDishes;

  @NonNull
  public final ShimmerFrameLayout shimmerLayout;

  protected ContentMainBinding(Object _bindingComponent, View _root, int _localFieldCount,
      RecyclerView recyclerViewDishes, ShimmerFrameLayout shimmerLayout) {
    super(_bindingComponent, _root, _localFieldCount);
    this.recyclerViewDishes = recyclerViewDishes;
