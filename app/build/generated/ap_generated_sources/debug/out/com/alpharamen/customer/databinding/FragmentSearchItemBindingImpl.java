...
public class FragmentSearchItemBindingImpl extends FragmentSearchItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.image_view_search, 7);
        sViewsWithIds.put(R.id.text_view_recent_search, 8);
        sViewsWithIds.put(R.id.recycler_view_search_items, 9);
    }
    // views
    @NonNull
    ...
    public FragmentSearchItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private FragmentSearchItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
