...
public class ActivityAboutUsBindingImpl extends ActivityAboutUsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_view_about_us_heading, 2);
        sViewsWithIds.put(R.id.text_view_about_details, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        else if (BR.aboutUs == variableId) {
            setAboutUs((com.alpharamen.customer.viewmodel.AboutUsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAboutUs(@Nullable com.alpharamen.customer.viewmodel.AboutUsViewModel AboutUs) {
