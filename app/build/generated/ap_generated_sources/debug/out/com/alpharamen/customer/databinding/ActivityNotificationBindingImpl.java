...
public class ActivityNotificationBindingImpl extends ActivityNotificationBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.notification == variableId) {
            setNotification((com.alpharamen.customer.viewmodel.NotificationViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setNotification(@Nullable com.alpharamen.customer.viewmodel.NotificationViewModel Notification) {
