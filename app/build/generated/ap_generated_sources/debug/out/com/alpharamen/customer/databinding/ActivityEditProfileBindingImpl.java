...
public class ActivityEditProfileBindingImpl extends ActivityEditProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_view_edit_profile, 4);
        sViewsWithIds.put(R.id.card_view_username, 5);
        sViewsWithIds.put(R.id.edit_text_user_name, 6);
        sViewsWithIds.put(R.id.card_view_email, 7);
        sViewsWithIds.put(R.id.edit_text_email, 8);
        sViewsWithIds.put(R.id.card_view_phone, 9);
        sViewsWithIds.put(R.id.edit_text_phone, 10);
        sViewsWithIds.put(R.id.card_view_house_name, 11);
        sViewsWithIds.put(R.id.edit_text_house_name, 12);
        sViewsWithIds.put(R.id.card_view_city, 13);
        sViewsWithIds.put(R.id.edit_text_city, 14);
        sViewsWithIds.put(R.id.card_view_pin, 15);
        sViewsWithIds.put(R.id.edit_text_pin, 16);
        sViewsWithIds.put(R.id.circleImageView, 17);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.editProfile == variableId) {
            setEditProfile((com.alpharamen.customer.viewmodel.EditProfileViewModel) variable);
        }
    ...
    public void setEditProfile(@Nullable com.alpharamen.customer.viewmodel.EditProfileViewModel EditProfile) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            this.imageViewCamera.setOnClickListener(listenerOnClickAndroidViewViewOnClickListener);
