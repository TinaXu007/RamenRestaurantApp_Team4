...
public abstract class FragmentNotificationBinding extends ViewDataBinding {
  @NonNull
  public final RecyclerView recyclerViewNotificationList;

  @NonNull
  public final TextView textViewNotificationHeading;

  @Bindable
  protected NotificationFragmentViewModel mNotify;

  protected FragmentNotificationBinding(Object _bindingComponent, View _root, int _localFieldCount,
      RecyclerView recyclerViewNotificationList, TextView textViewNotificationHeading) {
    super(_bindingComponent, _root, _localFieldCount);
    this.recyclerViewNotificationList = recyclerViewNotificationList;
    this.textViewNotificationHeading = textViewNotificationHeading;
  }

  public abstract void setNotify(@Nullable NotificationFragmentViewModel notify);

  @Nullable
  public NotificationFragmentViewModel getNotify() {
    return mNotify;
  }
